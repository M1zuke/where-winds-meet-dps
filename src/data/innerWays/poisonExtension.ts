// A cycle-free leaf: `src/data/classes/index.ts` registers every class's
// poison extension eagerly, at module-load time, so this stays independent of
// whatever `bitterSeasonMechanic.ts` itself imports.
//
