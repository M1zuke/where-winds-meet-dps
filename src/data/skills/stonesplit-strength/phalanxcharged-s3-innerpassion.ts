...
export const phalanxchargedS3Innerpassion = defineSkill({
  ...
  tags: [PROP.isCharged, PROP.shatteredRidgeBoost, PROP.consumesInnerPassionBurningHeart, WEAPON.moBlade, ATTACK.charge, ATTUNE.phalanxbaneCharged, ROLE.phalanxCharged],
  skillType: "weapon",
  ...
  hits: [
    ...
    hit(1, {
      ...
      attributeFixed: 604,
      triggers: [
        castSkill({ id: "tg-phalanxcharged-s3-innerpassion-cast", target: SKILL.anxisoldiermodown, stacks: 0 }),
      ],
    }),
  ],
