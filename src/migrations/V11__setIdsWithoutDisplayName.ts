// v10 → v11 — `Inputs.set` stops storing the set's display name and stores a
...
// which is also how a set retired by an earlier step arrives here.
...
export const V11__setIdsWithoutDisplayName: Migration = {
  to: 11,
  name: "V11__setIdsWithoutDisplayName",
